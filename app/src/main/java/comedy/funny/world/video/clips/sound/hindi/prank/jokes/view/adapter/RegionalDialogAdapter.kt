...
class RegionalDialogAdapter(val context: Context?, val songsList: List<List<String>>, val dialogListener: DialogListener) : RecyclerView.Adapter<DialogViewHolder>() {
