...
class BollywoodDialogAdapter(val context: Context?, val songsList: List<List<String>>, val dialogListener: DialogListener) : RecyclerView.Adapter<DialogViewHolder>() {
